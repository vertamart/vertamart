...
const ES_TERMS: Doc = {
  ...
  sections: [
    ...
    { h: '4. Entrega de productos digitales', p: ['Todos los productos de Vertamart son digitales y se entregan mediante descarga inmediata en tu biblioteca (Mis descargas) una vez confirmado el pago. No existen envíos físicos ni direcciones de entrega.'] },
    { h: '5. Licencias y soporte', p: ['Cada producto incluye la licencia indicada en su ficha (uso personal o comercial) y las actualizaciones y soporte descritos. La licencia no transfiere la propiedad del recurso, sino el derecho de uso según lo publicado.'] },
...
const EN_TERMS: Doc = {
  ...
  sections: [
    ...
    { h: '4. Digital delivery', p: ['All Vertamart products are digital and delivered via instant download in your library (My downloads) once payment is confirmed. There are no physical shipments or delivery addresses.'] },
    { h: '5. Licenses & support', p: ['Each product includes the license shown on its page (personal or commercial use) and the updates and support described. The license grants a right of use as published, not ownership of the asset.'] },
...
const ES_PRIVACY: Doc = {
  ...
  sections: [
    { h: '1. Qué datos recopilamos', p: ['Datos de cuenta (nombre, correo, país), datos de pedido (nombre, correo del comprador) y, si te suscribes, la referencia del pago. No almacenamos números de tarjeta ni CVV.'] },
    { h: '2. Para qué los usamos', p: ['Gestionar tu cuenta y pedidos, procesar pagos, habilitar tus descargas digitales, mostrar precios en tu moneda y mejorar la experiencia.'] },
    ...
    { h: '4. Con quién los compartimos', p: ['Solo con los proveedores necesarios para el funcionamiento (pago y correo) y siempre bajo las condiciones mínimas. No vendemos tus datos.'] },
...
const EN_PRIVACY: Doc = {
  ...
  sections: [
    { h: '1. What we collect', p: ['Account data (name, email, country), order data (buyer name, email) and, if you subscribe, the payment reference. We do not store card numbers or CVV.'] },
    { h: '2. How we use it', p: ['To manage your account and orders, process payments, enable your digital downloads, show prices in your currency and improve the experience.'] },
    ...
    { h: '4. Who we share with', p: ['Only with the providers required for operation (payment and email) and under minimum conditions. We never sell your data.'] },
